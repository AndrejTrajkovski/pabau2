...
//						firstSectionApp, viewStore.state.calendarType, viewStore.state.locations, viewStore.state.rooms, viewStore.state.employees, Calendar.gregorian.startOfDay(for: firstSectionApp.startDate))
