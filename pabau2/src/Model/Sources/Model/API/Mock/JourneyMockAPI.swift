...
extension JourneyMockAPI {
	...
	static let mockJourneys = [
		Journey.init(id: 1,
					 appointments: NonEmpty.init(Appointment.init(id: 1, from: Date() - 1.days, to: Date() - 1.days, employeeId: 1, employeeInitials: "AT", locationId: 1, locationName: "Thailand", status: AppointmentStatus.mock.randomElement()!, service: BaseService.init(id: 1, name: "Botox", color: "#9400D3"))),
		...
		Journey.init(id: 2,
					 appointments: NonEmpty.init(Appointment.init(id: 1, from: Date() - 1.days, to: Date(), employeeId: 1, employeeInitials: "MR", locationId: 1, locationName: "Skopje", status: AppointmentStatus.mock.randomElement()!, service: BaseService.init(id: 1, name: "Botox", color: "#ec75ff"))),
		...
		Journey.init(id: 3,
					 appointments: NonEmpty.init(Appointment.init(id: 1, from: Date() - 1.days, to: Date(), employeeId: 1, employeeInitials: "BB", locationId: 1, locationName: "Skopje", status: AppointmentStatus.mock.randomElement()!, service: BaseService.init(id: 1, name: "Botox", color: "#88fa69"))),
			...
			Journey.init(id: 4,
									 appointments: NonEmpty.init(Appointment.init(id: 1, from: Date(), to: Date(), employeeId: 1, employeeInitials: "WM", locationId: 1, locationName: "Manchester", status: AppointmentStatus.mock.randomElement()!, service: BaseService.init(id: 1, name: "Corona Virus", color: "#FFFF00"))),
			...
			Journey.init(id: 5,
									 appointments: NonEmpty.init(Appointment.init(id: 1, from: Date(), to: Date(), employeeId: 1, employeeInitials: "NJ", locationId: 1, locationName: "Birmingham", status: AppointmentStatus.mock.randomElement()!, service: BaseService.init(id: 1, name: "Botox", color: "#ec75ff"))),
			...
			Journey.init(id: 6,
									 appointments: NonEmpty.init(Appointment.init(id: 1, from: Date() + 1.days, to: Date(), employeeId: 1, employeeInitials: "RE", locationId: 1, locationName: "London", status: AppointmentStatus.mock.randomElement()!, service: BaseService.init(id: 1, name: "Botox", color: "#88fa69"))),
