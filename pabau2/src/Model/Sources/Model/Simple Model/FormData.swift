...
public struct FormData: Identifiable, Equatable {
...
extension FormData {
	...
	static let mockFilledConsents: [FormData] =
		[
			
		]
	
	static let mockFilledTreatments: [FormData] =
		[
			
		]
	
	static let mockFIlledPrescriptions: [FormData] =
		[
