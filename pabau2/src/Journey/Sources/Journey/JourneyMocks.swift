...
struct JourneyMocks {
	...
	static let checkIn = CheckInContainerState(
		journey:
		Journey.init(id: 1,
								 appointments: NonEmpty.init(Appointment.init(id: 1, from: Date() - 1.days, to: Date() - 1.days, employeeInitials: "PO", locationId: 1, locationName: "Skopje", status: AppointmentStatus.mock.randomElement()!, service: BaseService.init(id: 1, name: "Botox", color: "#9400D3"))),
